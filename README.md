...
2. [核心算法与数学推导 (Algorithmic Innovations)](#2-核心算法与数学推导-algorithmic-innovations)
    ...
    - [2.3 滑窗切块推理与高斯融合](#23-滑窗切块推理与高斯融合)
...
9. [工程防御与安全架构 (Engineering Security)](#9-工程防御与安全架构-engineering-security)
    - [9.1 数据空载防火墙](#91-数据空载防火墙)
    - [9.2 动态显存防爆](#92-动态显存防爆)
    - [9.3 完全边缘计算](#93-完全边缘计算)
10. [环境依赖与一键部署 (Installation)](#10-环境依赖与一键部署-installation)
    - [10.1 项目结构说明](#101-项目结构说明)
        - [10.1.1 各平台功能定位](#1011-各平台功能定位)
    - [10.2 核心依赖环境](#102-核心依赖环境)
    - [10.3 快速启动（推荐）](#103-快速启动推荐)
    - [10.4 手动启动方式（备用）](#104-手动启动方式备用)
